<template>
	<view>
		...
		<view class="top">
			...
			<view class="header">
				<view class="headerLeft" @click="leftClick">
				...
				<view class="headerRight">
					<image src="/static/image/trolley.png" @click="rigClick(0)" class="trolley"></image>
					<image src="/static/image/more.png" @click="rigClick(1)" class="more"></image>
				</view>
			</view>
			<view class="menu">
				<navigator open-type="switchTab"  class="activeMenu" url="/pages/index/index">首页</navigator>
				<navigator  v-for="(item,index) in menuArr" :key="index" :url="item.url" >{{item.menu}}</navigator>
			</view>
		</view>
		<view class="empty">
